...
class HeaderSection: 
  ...
  def create_widgets(self):
    ...
    self.toggle_button = tk.Button(
        ...
        fg=self.colours['accent'],
        activebackground=self.colours['hover'],
        activeforeground=self.colours['accent'],
        relief="flat",
        bd=0,
        width=3,
        height=1,
  ...
  def update_theme(self, colours, dark_mode):
        ...
        self.date_label.config(fg=colours['text_muted'], bg=colours['bg_primary'])
        self.prompt_label.config(fg=colours['text_primary'], bg=colours['bg_primary'])
